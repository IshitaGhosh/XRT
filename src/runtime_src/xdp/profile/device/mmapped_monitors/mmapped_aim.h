...
#ifndef XDP_PROFILE_DEVICE_MMAPPED_AIM_H
#define XDP_PROFILE_DEVICE_MMAPPED_AIM_H

#include "xdp/profile/device/aim.h"

namespace xdp {

/** Specialization for AIM Profile IP with support for open+mmap on device driver based AIM subdevice
 */

class MMappedAIM : public AIM
{
public:
  MMappedAIM(Device*  handle  /* XDP Device Abstraction handle : xrt or HAL device handle */
