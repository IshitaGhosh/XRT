...
namespace xdp {
  ...
  void AieHaltClientDevImpl::updateDevice(void* /*hwCtxImpl*/)
  {
    ...
    xrt_core::message::send(xrt_core::message::severity_level::debug, "XRT", 
              "Allocated buffer In AieHaltClientDevImpl::updateDevice");
  #endif
  }
  ...
  void AieHaltClientDevImpl::finishflushDevice(void* /*hwCtxImpl*/)
  {
#if 0
    xrt_core::message::send(xrt_core::message::severity_level::debug, "XRT", 
              "Using Allocated buffer In AieHaltClientDevImpl::finishflushDevice");
    ...
    xrt_core::message::send(xrt_core::message::severity_level::debug, "XRT", 
              "Finished writing record_timer_ts.json in AieHaltClientDevImpl::finishflushDevice");
