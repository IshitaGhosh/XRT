...
namespace xdp {
  ...
  GenAsmElfClientDevImpl::GenAsmElfClientDevImpl(VPDatabase*dB)
    : GenAsmElfImpl(dB)
  {
  }
...
#endif
  void GenAsmElfClientDevImpl::updateDevice(void* hwCtxImpl)
  {
    xrt_core::message::send(xrt_core::message::severity_level::debug, "XRT",
              "In GenAsmElfClientDevImpl::updateDevice");

    std::unique_ptr<aie::ClientTransaction> txnHandler
        = std::make_unique<aie::ClientTransaction>(mHwContext, " GenAsmElf");
    ...
    try {
      ...
      std::string msg(" Metadata could not be read/processed from xclbin: ");
      msg += e.what();
...
#pragma warning(pop)
#endif
  void GenAsmElfClientDevImpl::finishflushDevice(void* /*hwCtxImpl*/)
  {
  }
}
