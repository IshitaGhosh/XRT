...
#ifndef XDP_MULTI_PDI_PROF_PLUGIN_H
#define XDP_MULTI_PDI_PROF_PLUGIN_H
...
namespace xdp {
  ...
  class MultiPDIProfPlugin : public XDPPlugin
  {
    public:
    ...
    struct DeviceData {
      bool valid;
      std::unique_ptr<MultiPDIProfImpl> implementation;
    } DeviceDataEntry;
