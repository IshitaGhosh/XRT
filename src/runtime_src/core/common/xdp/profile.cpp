...
namespace xrt_core::xdp::aie_halt {
...
load()
{
  static xrt_core::module_loader xdp_loader("xdp_aie_halt_plugin",
                                                register_callbacks,
                                                warning_callbacks);
}
...
} // end namespace xrt_core::xdp::aie_halt
...
update_device(void* handle)
{
  ...
  if (xrt_core::config::get_aie_halt()) {
    try {
      xrt_core::xdp::aie_halt::load();
    }
    catch (...) {
      return;
    }
    xrt_core::xdp::aie_halt::update_device(handle);
  }
...
finish_flush_device(void* handle)
{
  ...
  if (xrt_core::config::get_aie_halt())
    xrt_core::xdp::aie_halt::finish_flush_device(handle);
#else
